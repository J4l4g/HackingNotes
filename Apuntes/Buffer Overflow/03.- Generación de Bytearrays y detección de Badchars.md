...
A la hora de generar nuestro *ShelCode* para explotar el bufferoverflow es posible que algunos caracteres no sean interpretados correctamente estos son conocidos como *Badchars*.
