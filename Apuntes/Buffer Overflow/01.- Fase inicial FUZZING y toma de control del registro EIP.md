...
```
Ejecutamos de nuevo y en el Inmunity en la maquina Windows comprobamos si en el valor del registro de *EIP* se corresponde a `42424242` que corresponde a cuatro `B` 