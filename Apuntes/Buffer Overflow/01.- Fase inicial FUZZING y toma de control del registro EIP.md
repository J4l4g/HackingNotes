...
```
Volvemos a ejecutar el exploit, y en la maquina Windows del laboratorio donde estamos haciendo la prueba donde en el Inmunity en el registro *EIP* nos pone el ultimo valor que ha almacenado, este valor hay que pasárselo a la siguiente herramienta de [[METASPLOIT]]