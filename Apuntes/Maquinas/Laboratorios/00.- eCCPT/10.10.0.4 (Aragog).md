...
Ahora cuando queramos hacer una enumeración de puertos de la maquina victima [[10.10.0.5(Nagini)]] deberemos usar `proxychains nmap -sT -Pn -p- -open -T5 -v -n 10.10.0.5 2>/dev/null`
