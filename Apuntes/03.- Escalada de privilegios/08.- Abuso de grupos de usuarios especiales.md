...
- Grupo lxd
	...
	en la maquina atacante y nos lo compartimos a la atacante y en esta ejecutamos el `.sh` y con la opción `-f` indicamos la ruta del comprimido nos abrirá el contenedor y en la ruta
	`/mnt/root` haremos lo mismo que con el Docker.